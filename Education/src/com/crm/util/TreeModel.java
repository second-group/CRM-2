...
public class TreeModel {
	...
	public TreeModel(int id, String text, ArrayList<TreeModel> children, int m_parentid, String m_path) {
		super();
		this.id = id;
		this.text = text;
	...
	public String toString() {
		return "TreeModel [id=" + id + ", text=" + text + ", children=" + children + ", m_parentid=" + m_parentid
				+ ", m_path=" + m_path + "]";
	}
